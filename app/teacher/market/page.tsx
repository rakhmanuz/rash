...
export default function MarketPage() {
  ...
  const handleCheckout = async (e: React.FormEvent) => {
    ...
    const totalInfinityPrice = getTotalInfinityPrice()
    if (totalInfinityPrice > infinityPoints) {
      alert(`Yetarli infinity ballar yo'q! Sizda: ∞ ${infinityPoints}, kerak: ∞ ${totalInfinityPrice}`)
      return
    }
    ...
    try {
      ...
      if (response.ok) {
        ...
        fetchProducts()
        fetchInfinityPoints() // Infinity ballarni yangilash
      } else {
